    ...
    <div class="detail-container">
        ...
        <section class="detail-info-section">
            ...
            <div class="detail-actions">
                <!-- お気に入りボタン (修正済み: 二重ボタンを解消) -->
                <div class="action-item-wrapper">
                    <button class="action-item" id="like-button" type="button">
                        <span class="action-icon">
                            <svg class="heart-icon" xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a href="#comment-section" class="action-item">
                    <span class="action-icon">
                        <svg class="comment-icon" xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
